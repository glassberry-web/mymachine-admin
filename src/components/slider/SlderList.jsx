...
function SliderList({ productListResponse}) {
    const [loading, setLoading] = useState(false)   
    const [sortedData, setSortedData] = useState(productListResponse);
    console.log("sliderListResponse--->", productListResponse);
    ...
    const deletePost = async (id, name) => {
        ...
        try {
            if (confirmDelete) {
                const deletedData =
                    await axios.delete(`/enquiry/deleteSlider/${id}`, {
                ...
                <thead className="gridjs-thead">
                    <tr className="gridjs-tr">
                        ...
                        <th
                            ...
                            style={{ width: "200px" }}
                        >
                            <div className="gridjs-th-content">Slider_title</div>
                            {/* <button                               
                        ...
                        <th
                            ...
                            style={{ width: "200px" }}
                        >
                            <div className="gridjs-th-content">Slider_image</div>
                            {/* <button
                                tabIndex={-1}
                                onClick={toggleSortOrder}                               
                                className="gridjs-sort gridjs-sort-neutral"
                        ...
                        <th
                            ...
                            style={{ width: "200px" }}
                        >
                            <div className="gridjs-th-content">Slider_discription</div>
                            {/* <button
                                tabIndex={-1}
                                onClick={toggleSortOrder}                               
                                className="gridjs-sort gridjs-sort-neutral"
                ...
                <tbody className="gridjs-tbody">
                  ...
                  {product.brand}
                                    ...
                                    <td data-column-id="price" className="gridjs-td">
                                        <span>{slider.slider_discription || "--"}</span>
                                    </td>
                                        ...
                                        <span>
                                            <div className="dropdown">
                                                ...
                                                <ul className="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <Link to={`/editSlider/${slider.slider_name}`} state={{ id: `${slider._id}`, namee: `${slider.slider_name}` }}
                                                    ...
                                                    <li>
                                                        <Link
                                                            onClick={() => deletePost(slider._id, slider.slider_name)}
