...
function AddCompanyForm({ companyDetails, ADD_COMPANY_DETAILS, navigateTo }) {
  ...
  console.log("comformdata", formdata);
  ...
  const submitHandler = async (data) => {
    ...
    try {
      ...
      formData.append("company_description",  formdata);
    ...
    >
      <div className="row">
        <div className="col-lg-8">
          ...
          <div className="card">
          <div className="card-header">
              <h5 className="card-title mb-0">Company Full Discription</h5>
            </div>
            <div className="card-body">
              <div className="mb-3">
                {/* <div>
              ...
              <div className="row g-3 mb-3 ">
                <div className="col-md-12">
                  ...
                  useMemo(() => <JoditEditor                
                        ref={editor}
                        value={formdata}
                        // placeholder={companyDetails?.company_description || "_"}
                        config={editorConfig}  
                        onChange={(newContent) => setFormData(newContent)}              
                        // onChange={(newContent) =>
                        //   setFormData((prevFormData) => ({
                        //     ...prevFormData,
                        //     company_description: newContent,
                        //   }))
                        // }
                        />  ,[])    
                  }            
                  ...
                  {/* <input
                    ...
                    id="datepicker-publish-input"
                    className="form-control"
                    defaultValue={companyDetails?.company_description|| ""}
                    placeholder={companyDetails?.company_description || "_"}
                    {...register("company_description", {
                      required: false,
                    })}
